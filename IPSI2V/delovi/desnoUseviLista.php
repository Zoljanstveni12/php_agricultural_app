...
if ($UseviViewObject->BrojZapisa==0)
	...
	echo "UKUPAN BROJ ZAPISA:".$UseviViewObject->BrojZapisa;
		...
		echo "</td>";
		echo "<td>";
		echo "<form ACTION=\"useviIzmeniForm.php\" METHOD=\"POST\">";
		echo "<input type=\"hidden\" name=\"ID\" value=\"$ID\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"izmeniUpis\" value=\"IZMENI\" /></font></b>";
		echo "</form>";
		echo "</td>";
		echo "<td>";
		echo "<form ACTION=\"useviObrisi.php\" METHOD=\"POST\">";
		echo "<input type=\"hidden\" name=\"ID\" value=\"$ID\">";
		echo "<b><font face=\"Trebuchet MS\" color:#3F4534 size=\"2px\"><input TYPE=\"submit\" name=\"obrisiUpis\" value=\"OBRISI\"  onclick=\"return confirm('Da li ste sigurni da zelite da obrisete zapis?')\"/></font></b>";
		echo "</form>";
		echo "</td>";
		echo "</tr>";
